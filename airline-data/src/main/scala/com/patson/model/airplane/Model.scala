...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Embraer ERJ-NG185-E", "Embraer Next Generation", capacity = 83, fuelBurn = (83 * 2.2).toInt, speed = 585, range = 1235, price = 57000000, lifespan = 35 * 52, constructionTime = 4, Manufacturer("Embraer", countryCode = "BR"), runwayRequirement = 1975, imageUrl = "https://www.norebbo.com/embraer-erj-175-templates-with-the-new-style-winglets/"),
    Model("Embraer ERJ-NG185-H", "Embraer Next Generation", capacity = 92, fuelBurn = (92 * 2.6).toInt, speed = 845, range = 5492, price = 52000000, lifespan = 35 * 52, constructionTime = 4, Manufacturer("Embraer", countryCode = "BR"), runwayRequirement = 2215, imageUrl = "https://www.norebbo.com/embraer-erj-175-templates-with-the-new-style-winglets/"),
    Model("Embraer ERJ-NG185-K", "Embraer Next Generation", capacity = 100, fuelBurn = (100 * 2.9).toInt, speed = 875, range = 4896, price = 45000000, lifespan = 35 * 52, constructionTime = 4, Manufacturer("Embraer", countryCode = "BR"), runwayRequirement = 2215, imageUrl = "https://www.norebbo.com/embraer-erj-175-templates-with-the-new-style-winglets/"),
    ...
    Model("Airbus A321-H", "Airbus A320", capacity = 219, fuelBurn = (219 * 3.9).toInt, speed = 832, range = 7220, price = 165000000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 2190, imageUrl = "https://www.norebbo.com/2014/03/airbus-a321-blank-illustration-templates/"),
    Model("Airbus A321-E", "Airbus A320", capacity = 200, fuelBurn = (200 * 3).toInt, speed = 659, range = 1250, price = 15000000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 1850, imageUrl = "https://www.norebbo.com/2014/03/airbus-a321-blank-illustration-templates/"),
    Model("Airbus A321-EVTOL", "Airbus A320", capacity = 189, fuelBurn = (189 * 3.3).toInt, speed = 655, range = 1180, price = 158000000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 50, imageUrl = "https://www.norebbo.com/2014/03/airbus-a321-blank-illustration-templates/"),
